...
export default function EventsClient({ initialUpcomingEvents, initialPastEvents, initialCounts, userId }: EventsClientProps) {
  ...
  // Check-in feedback (success popup, vibrate, redirect) is handled app-wide by
  // <CheckInListener> mounted in the root layout, so it works from any screen —
  // including the dashboard QR — not just while this page's QR modal is open.
