...
import { 
  ...
  QrCode, Clock, CheckCircle2, ShieldCheck 
} from "lucide-react";
...
export default function EventsPage() {
  const events = [
    {
      id: "event-01",
      title: "YDC Pioneers Camp 2026",
      date: "December 20-21, 2026",
      time: "9:00 AM - 5:00 PM",
      location: "Islamic Center, Multan",
      description: "Our flagship 2-day orientation and leadership development camp designed for newly recruited regional youth leaders.",
      capacity: 50,
      joined: true,
      ticketCode: "TKT-8222E-PION"
    },
    {
      id: "event-02",
      title: "Tech Skill-Up: Bano Qabil Intro",
      date: "June 15, 2026",
      time: "2:00 PM - 4:00 PM",
      location: "YDC IT Lab, Multan",
      description: "Hands-on intro session explaining how technology, coding, and digital marketing build self-reliant career growth.",
      capacity: 100,
      joined: false,
      ticketCode: null
    },
    {
      id: "event-03",
      title: "Community Khidmat: Plantation Drive",
      date: "June 22, 2026",
      time: "8:00 AM - 11:00 AM",
      location: "Bosan Road Sectors, Multan",
      description: "A collaborative community action planting over 500 saplings to advocate environmental responsibility and team work.",
      capacity: 80,
      joined: false,
      ticketCode: null
    }
      ...
      <header className="border-b border-slate-800 bg-slate-900/60 backdrop-blur sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg tracking-tight text-white">YDC Events</span>
          </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 grid lg:grid-cols-3 gap-8">
          ...
          {events.map((event) => (
            <div 
              ...
              className={`p-6 rounded-2xl border bg-slate-900/30 flex flex-col md:flex-row justify-between gap-6 transition-all duration-300 ${
                event.joined ? 'border-ydc-blue/40 shadow-lg shadow-ydc-blue/5' : 'border-slate-800/80 hover:border-slate-800'
              }`}
            >
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-bold text-white">{event.title}</h3>
                  <p className="text-xs text-slate-400 mt-1 leading-relaxed max-w-xl">{event.description}</p>
                </div>
              ...
              <div className="flex items-center justify-end shrink-0 md:border-l md:border-slate-850 md:pl-6">
                {event.joined ? (
                  <div className="text-center w-full md:w-auto">
                    ...
                    <button className="w-full md:w-auto px-4 py-2 border border-slate-800 hover:border-slate-700 bg-slate-950 text-xs font-semibold rounded-xl text-slate-300 transition-colors flex items-center justify-center gap-2">
                      <Ticket size={14} />
                      Show Ticket
                    </button>
                  </div>
                ) : (
                  <button className="w-full md:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-ydc-blue to-ydc-blue-dark font-bold text-white shadow-lg hover:shadow-ydc-blue/15 hover:scale-105 active:scale-95 transition-all text-xs cursor-pointer">
                    Claim Ticket
                  </button>
                )}
              </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="p-6 rounded-2xl border border-ydc-blue/30 bg-slate-900/50 text-center relative overflow-hidden shadow-xl shadow-ydc-blue/5">
            ...
            <h3 className="font-bold text-white text-base">YDC Pioneers Camp 2026</h3>
            <p className="text-xs text-slate-400 mt-1">December 20-21 &bull; Islamic Center Multan</p>
