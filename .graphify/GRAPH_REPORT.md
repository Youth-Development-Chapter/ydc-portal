...
## Corpus Check
- 170 files · ~106,798 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 722 nodes · 1870 edges · 28 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output
- Edge kinds: MODIFIES: 553 · contains: 503 · imports: 270 · imports_from: 225 · reads_from: 109 · PARENT_OF: 69 · ON_BRANCH: 67 · calls: 29 · references: 26 · triggers: 16 · conceptually_related_to: 2 · semantically_similar_to: 1


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 170 · Candidates: 182
- Excluded: 210 untracked · 27779 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `c06ef93`
...
Cohesion: 0.05
Nodes (49): ALLOWED_MIME_TYPES, claimTicket(), getEventsFromServer(), main, 07226c4 Add event posters, archiving & roster features, 2b98c86 Replace Coolvetica with Google Poppins font, 390bb7c perf: optimize hot queries and add cache-safe data helpers, 430dc36 Update OnboardingClient.tsx (+41 more)

### Community 1 - "Core Relational Database Schema"
Cohesion: 0.05
Nodes (38): 02a44a2 Add bilingual (Urdu) support for courses, 03e257b feat: complete dashboard, auth system, and LMS native integration, 670c0c3 Add server lms-data and refactor wellms, 8cc013d Add dynamic dashboard flashcards and UI refinements, 8eb7aa8 Add course rewards and server-side quiz grading, 9abbc7f Add profile onboarding flow and redirects, a227584 Add LMS gamification rewards & UI updates, c0dc632 Add Urdu localization to lessons and UI (+30 more)

### Community 2 - "QR Ticket Scan Widgets"
Cohesion: 0.07
Nodes (18): metadata, notoNastaliqUrdu, poppins, 2c7d0ff Add admin LMS UI, admin actions, and APIs, 986cd4b Split President console; add event & deed UIs, c06ef93 fixed check in logic, d17ee1f Add fluid top gradient, tweak dashboard headers, fb18f2e Add division scoping, reward edits, admin UI (+10 more)
...
Cohesion: 0.06
Nodes (23): AdminNavProps, AdminPermissions, NavItem, NavSection, ROOT_ITEMS, SECTIONS, ErrorDetails, 28caec0 fix(auth): resolve PKCE verifier loss on OAuth and hydration mismatch on error page (+15 more)
...
Cohesion: 0.11
Nodes (21): 463284b Enforce 3-per-day deeds and add UI components, fc9a24e fix(gamification): correct flag double-deduction, streak basis, and event capacity, public.coin_transactions, public.handle_deed_coins(), has_deed, latest_deed_date, longest, public.deed_submissions (+13 more)
...
Cohesion: 0.13
Nodes (14): adjustUserCoins(), deleteUserProfile(), getUserFullHistory(), updateUserAdminRole(), updateUserProfileAdmin(), DirectoryUser, GranularPermissions, 80ff45f Add AdminNav, Sonner toasts & UI refresh (+6 more)
...
- **Thin community `User Profile Editing`** (1 nodes): `YDC Colored Logo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Event Creation Actions`** (1 nodes): `YDC Portal Logo Icon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Streak and Coin Ledgers`** (1 nodes): `YDC Transparent Logo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createClient()` connect `QR Ticket Scan Widgets` to `Reward Shop Redemptions`, `Deed Approval Database Triggers`, `LMS Authoring and Course Management`, `Deed Approvals and Reviews`, `Event RSVPs and Deed Logging`, `Core Relational Database Schema`, `User Admin Directory and Roles`, `Volunteer Authentication Session`, `Deed Streak PostgreSQL Calculations`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Button` connect `Deed Approvals and Reviews` to `LMS Lesson Quiz Submissions`, `Reward Shop Redemptions`, `Event Capacity Enforcement`, `Deed Approval Database Triggers`, `Course Completion Rewards`, `Volunteer Authentication Session`, `Event RSVPs and Deed Logging`, `Admin Course Directory`, `LMS Authoring and Course Management`, `Core Relational Database Schema`, `User Admin Directory and Roles`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `getAdminContext()` connect `QR Ticket Scan Widgets` to `Reward Shop Redemptions`, `Deed Approval Database Triggers`, `LMS Authoring and Course Management`, `Core Relational Database Schema`?**
