...
- "events_eventsclient": "EventsClient.tsx" | kind=code-symbol | source=src/app/events/EventsClient.tsx:L1 | neighbors=[07226c4 Add event posters, archiving & …, 0aff7f1 add graphify, 35fbf30 Introduce units and unit-based …, 390bb7c perf: optimize hot queries and …, 51e7e61 perf: fix tag invalidation sign…, 7026f95 update events]
