...
- "not_going_route": "route.ts" | kind=code-symbol | source=src/app/api/events/not-going/route.ts:L1 | neighbors=[7026f95 update events, POST(), api.ts, createApiClient()] | lang=en
