...
- "admin_actions_bulkprocessleaves": "bulkProcessLeaves()" | kind=code-symbol | source=src/app/admin/actions.ts:L1891 | neighbors=[actions.ts, EventDetailsClient.tsx]
...
- "app_actions_claimticket": "claimTicket()" | kind=code-symbol | source=src/app/actions.ts:L22 | neighbors=[actions.ts, EventsClient.tsx]
- "app_actions_geteventsfromserver": "getEventsFromServer()" | kind=code-symbol | source=src/app/actions.ts:L193 | neighbors=[actions.ts, EventsClient.tsx]
- "app_actions_logdeed": "logDeed()" | kind=code-symbol | source=src/app/actions.ts:L90 | neighbors=[actions.ts, LogDeedForm.tsx]
