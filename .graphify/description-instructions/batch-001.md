...
- "notifications_page": "page.tsx" | kind=code-symbol | source=src/app/dashboard/president/notifications/page.tsx:L1 | neighbors=[0aff7f1 add graphify, 54a4d65 Replace announcements with noti…, 7026f95 update events, PresidentNotificationsClient.tsx, admin.ts, getAdminContext()] | lang=en
...
- "commit:repo:github.com/Youth-Development-Chapter/ydc-portal@0aff7f1730e25a37df5aaeed917a9f18f0f02c1f": "0aff7f1 add graphify" | kind=Commit | source=git | neighbors=[actions.ts, EventDetailsClient.tsx, EventsManager.tsx, actions.ts, main, route.ts] | lang=en
...
- "commit:repo:github.com/Youth-Development-Chapter/ydc-portal@7026f95e3166249e0c5a0a047dc39c23c3317e3f": "7026f95 update events" | kind=Commit | source=git | neighbors=[0aff7f1 add graphify, actions.ts, EventDetailsClient.tsx, actions.ts, main, DashboardFlashcards.tsx] | lang=en
