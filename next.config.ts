...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
  {
    ...
    value: [
      ...
      // Allow images from same origin, Supabase storage, R2, sslip.io, ydc domains, and data URIs
      "img-src 'self' data: blob: https://*.supabase.co https://*.r2.dev https://*.cloudflare.com https://images.unsplash.com http://*.sslip.io https://*.sslip.io https://db.ydc.org.pk",
